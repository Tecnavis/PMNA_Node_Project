...
const Bookings: React.FC = () => {
    ...
    const fetchBookings = async (searchTerm = '', page = 1, limit = 10) => {
        try {
            const data: AllBookingResponse = await getBookings({ search: searchTerm, page, limit, status : statusConditions }) as AllBookingResponse
        ...
        <div className="grid xl:grid-cols-1 gap-6 grid-cols-1">
            <div className="panel">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
                    {/* Heading */}
                    <h5 className="font-semibold text-lg dark:text-white-light sm:w-auto w-full text-center sm:text-left">Booking Details</h5>

...
export const handlePrint = (
    ...
    driver: Driver,
    bookings: Booking[],
    totalCalculatedUpdatedTotalSalary: number,
    ...
    if (printWindow && printContent) {
        ...
        const printedBy = role === 'staff' ? `Printed By: ${role}` : 'Printed By: Admin';
        printWindow.document.write(`
        ...
        printWindow.document.write(`
            ...
            <div class="card-container">
                ...
                <div class="card">
                    <div class="title">Balance in ${selectedMonth}: </div>
                    <div class="value">
                ...
                <div class="card">
                    <div class="title">Net Total Amount in Hand: </div>
                    <div class="value">₹ ${driver?.cashInHand}</div>
                </div>
            </div>
        `);
        ...
        printWindow.document.write(`
            <table class="table-container">
                ...
                <tbody>
                    ...
                    <td>${booking.driverSalary}</td>
                    <td>${booking.transferedSalary || 0}</td>
                    <td>${(booking?.driverSalary || 0) - (booking.transferedSalary || 0)}</td>
                    </tr>
                    `).join('')}
                </tbody>
            </table>

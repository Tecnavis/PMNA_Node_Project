    ...
    const handleDelete = (itemId: any) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios.delete(`${backendUrl}/driver/${itemId}`);
                // Remove role logic
                setDrivers((prev) => prev.filter((item) => item._id !== itemId));
                Swal.fire('Deleted!', 'The driver has been deleted.', 'success');
            }
        });
    };

    // getting driver by id in modal
        ...
        <div className="grid xl:grid-cols-1 gap-6 grid-cols-1">
            <div className="panel">
                <div className="flex items-center justify-between mb-5">
                    ...
                    <Link to="/driveradd" className="font-semibold text-success hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600">
                                ...
                                <tr key={index}>
                                    ...
                                    <td className="text-center">
                                        <ul className="flex items-center justify-center gap-2">
                                            ...
                                            <li>
                                                <Tippy content="Edit">
                                                    <button type="button" onClick={() => navigate(`/driveradd/${items._id}`)}>
                            ...
                            >
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-5xl my-8 text-black dark:text-white-dark">
                                    <div className="flex bg-[#fbfbfb] dark:bg-[#121c2c] items-center justify-between px-5 py-3">
                                        <h5 className="font-bold text-lg">{driver && driver.name ? driver.name.charAt(0).toLocaleUpperCase() + driver.name.slice(1) : 'Loading...'}</h5>
                                                ...
                                                <div className="col-12">
                                                    ...
                                                    >
                                                        <img
                                                            ...
                                                            src={driver?.image ? `${backendUrl}/images/${driver?.image}` : defaultImage}
                                                            alt=""
                                                        />
                                                    </div>
                                                    <div className="col-12">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        >
                                                                            {isVisible ? driver?.password : driver?.password?.replace(/./g, '*')}
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        ...
                                                        <table>
                                                            ...
                                                            <tbody>
                                                                {driver?.vehicle.map((items, index) => (
                                                                    <tr key={index}>
                                    ...
                                    <div className="flex justify-end items-center mt-8 mb-3 mr-3">
                                        <button onClick={() => navigate(`/driveradd/${driver?._id}`)} type="button" className="btn btn-outline-primary mr-3">
                                            <IconPencil />
                                        </button>

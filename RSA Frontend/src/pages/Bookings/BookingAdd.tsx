...
//     console.log("selected compnay", selectedCompany)
...
//                                 <div style={{ flex: '1' }}>
//                                     <button type="button" className={`btn w-full mt-2 ${selectedEntity ? 'btn-success' : 'btn-primary'}`} onClick={openDriverModal}>
//                                         {' '}
//                                         {selectedEntity ? <p ref={selectedEndityRef}>{selectedEntity.name}</p> : <p>Select Driver</p>}
//                                     </button>
//                                 </div>
...
//                                     Drivery salary is :<span style={{ marginLeft: '10px' }}>₹{driverSalary}</span>
//                                 </h2>
//                             </div>
//                         )}
//                         <div>

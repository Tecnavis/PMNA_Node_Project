                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                                                <div style={{ display: 'flex', gap: '10px' }}>
                                                    ...
                                                    <button
                                                        onClick={() => {
                                                            setModalOpen(true)
                                                            setUrl(`http://rsa-staff-ilqh.onrender.com/auth/cover-register?id=${items._id}&name=${items.name}&location=${items.location}&image=${items.image}&helpline=${items.helpline}&phone=${items.phone}&state=${items.state}&district=${items.district}`)
                                                        }}
                                                        style={{

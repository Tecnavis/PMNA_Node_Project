        ...
        <div className="grid xl:grid-cols-1 gap-6 grid-cols-1">
            <div className="panel">
                <div className="flex items-center justify-between mb-5">
                    ...
                    <Link to="/companyadd" className="font-semibold text-success hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600">
                                ...
                                <tr key={index}>
                                    ...
                                    <td className="text-center">
                                        <ul className="flex items-center justify-center gap-2">
                                            ...
                                            <li>
                                                <Tippy content="Edit">
                                                    <button type="button" onClick={() => navigate(`/companyadd/${items._id}`)}>
